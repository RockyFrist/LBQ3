...
export const PARRY_BOOST = {
  precise:    { mult: 0.80, duration: 0.80 },
  semi:       { mult: 0.85, duration: 0.80 },
  nonPrecise: { mult: 0.90, duration: 0.60 },
};
...
export const HEAVY_ATTACK_LUNGE  = 18;   // 重击前冲（稍收敛，避免格挡后贴脸）
export const HEAVY_ATTACK_DRIFT  = 35;   // 重击active前压（降速，给防守方反应空间）
...
export const PARRY_PULL_SLIDE_DURATION = 0.20; // 格挡拉近滑动时长（比击退慢，视觉可见）
...
export const PARRY_TIME_SCALE = {
  precise:    { scale: 0.12, duration: 1.40 },
  semi:       { scale: 0.15, duration: 1.10 },
